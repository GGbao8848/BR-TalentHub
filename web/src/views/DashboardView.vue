...
.hbar-wrap { min-height: 200px; max-height: 380px; overflow-y: auto; padding-right: 4px; }
.hbar-wrap::-webkit-scrollbar { width: 6px; }
.hbar-wrap::-webkit-scrollbar-thumb { background: #cbd5e1; border-radius: 3px; }
